        ...
        <div class="d-flex align-items-stretch">
          <div id="sidebar" class="sidebar py-3">
            ...
            <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="kullanicilar.php"  class="sidebar-link text-muted <?php if ($sayfa == 'kullanicilar') echo "active";?>"><i class="fa fa-globe mr-3 text-gray"></i><span>Kullanıcılar</span></a>
              </li>

              <li class="sidebar-list-item"><a href="araclar.php"  class="sidebar-link text-muted <?php if ($sayfa == 'araclar') echo "active";?>"><i class="fa fa-globe mr-3 text-gray"></i><span>Araçlar</span></a>
              </li>



              <li class="sidebar-list-item"><a href="gider-listesi.php"  class="sidebar-link text-muted <?php if ($sayfa == 'gider') echo "active";?>"><i class="fa fa-globe mr-3 text-gray"></i><span>Gider Listesi</span></a>
              </li>
